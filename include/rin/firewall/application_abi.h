...
#define RIN_FIREWALL_APPLICATION_CONTEXT_VERSION UINT16_C(1)
...
#pragma pack(push, 1)
typedef struct RinFirewallApplicationContextV1 {
...
} RinFirewallApplicationContextV1;
#pragma pack(pop)

#if defined(__cplusplus)
static_assert(sizeof(RinFirewallApplicationContextV1) == 128u,
              "Firewall application context ABI drift");
#elif defined(__STDC_VERSION__) && __STDC_VERSION__ >= 201112L
_Static_assert(sizeof(RinFirewallApplicationContextV1) == 128u,
               "Firewall application context ABI drift");
#endif
