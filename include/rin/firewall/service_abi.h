...
#define RIN_FIREWALL_SERVICE_ABI_VERSION UINT32_C(2)
...
/* Allows edits to the caller's application rules only. */
#define RIN_FIREWALL_SERVICE_CAP_USER_RULES UINT32_C(0x00000040)
#define RIN_FIREWALL_SERVICE_KNOWN_CAPS \
    (RIN_FIREWALL_SERVICE_CAP_READ | RIN_FIREWALL_SERVICE_CAP_ADMIN | \
     ...
     RIN_FIREWALL_SERVICE_CAP_USER_RULES)
...
typedef enum RinFirewallServiceEventTypeV1 {
    ...
    RIN_FIREWALL_SERVICE_EVENT_CONFIGURATION_RECOVERED = 5
